...
# Build Engine
Start-Process -FilePath "$PSScriptRoot\..\UnrealEngine\Setup.bat"
Start-Process -FilePath "$PSScriptRoot\..\UnrealEngine\GenerateProjectFiles.bat"
...
. Engine\Build\BatchFiles\RunUAT.bat BuildCookRun -project="$PSScriptRoot\..\RT_FPS.uproject" -noP4 -platform=Win64 -clientconfig=Development -serverconfig=Development -cook -allmaps -build -stage -pak -archive -archivedirectory="$PSScriptRoot\..\Build\RT_FPS"